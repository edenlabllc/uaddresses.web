...
export const API_ENDPOINT = config.API_ENDPOINT || process.env.API_ENDPOINT || 'https://uaddresses-api-dev.herokuapp.com';

export const SITEMAP_HOSTNAME = process.env.SITEMAP_HOSTNAME || 'https://uaddresses-api-dev.herokuapp.com'; // used in sitemap
